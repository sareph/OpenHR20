 ...
 * \date       $Date: 2011-04-04 21:14:19 +0200 (Pn, 04 kwi 2011) $
 * $Rev: 359 $
 */
...
#else
#ifndef RFM
#define RFM 0 //!< define RFM to 1 if you want to have support for the RFM Radio Moodule in the Code
#endif
#endif
...
// Some default Values
#define BOOT_DD        21  //!< Boot-Up date: day

 ...
 * \date       $Date: 2010-02-01 12:53:27 +0100 (Pn, 01 lut 2010) $
 * $Rev: 273 $
 */
...
void task_keyboard(void)
{
	...
	{	// wheel
		...
		if ((wheel ^ state_wheel_prev) & KBI_ROT1)
		{	//only ROT1 have interrupt, change detection
